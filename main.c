...
int main() {
  ...
  printf("\nList after removing from index 3: ");
  list_print(mylist);

  list_remove_at_index(mylist, 20);
  printf("\nList after removing from index 20: ");
  list_print(mylist);
  list_remove_at_index(mylist, 0);
  printf("\nList after removing from index 0: ");
  list_print(mylist);
  elem front = list_remove_from_front(mylist);
  printf("\nNumber removed from front: %d\n", front);
  printf("\nList after removing from front: ");
  list_print(mylist);
  printf("\nList length: %d\n", list_length(mylist));

  elem back = list_remove_from_back(mylist);
  printf("Number removed from back: %d\n", back);
  printf("List after removing from back: ");
  list_print(mylist);
  printf("List length: %d\n", list_length(mylist));
  ...
  list_add_to_back(mylist, 5);
  printf("\nList after adding to back: ");
  list_print(mylist);
  printf(" List length: %d\n", list_length(mylist));

  bool is_in_list = list_is_in(mylist, 5);
  printf("Is 5 in the list? %s\n", is_in_list ? "Yes" : "No");

  elem elem_at_index = list_get_elem_at(mylist, 2);
  printf("Element at index 2: %d\n", elem_at_index);

  int index_of_elem = list_get_index_of(mylist, 11);
  printf("Index of 11: %d\n", index_of_elem);

  list_add_at_index(mylist, 50, 0);
  list_add_at_index(mylist, 40, 1);
  printf("List after adding at specific indexes: ");
  list_print(mylist);
